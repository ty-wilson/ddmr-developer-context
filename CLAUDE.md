...
- **mdm-schema-ingest-inbound-adapter**: Hourly Lambda that ingests Apple DDM repo → transforms → S3.
...
- **micro-frontend-hub**: Nx + pnpm monorepo holding all MFE apps (declarations, config-profiles, JSFG, etc.)
